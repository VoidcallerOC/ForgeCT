...
- nicklife.xyz = clients / pipeline / money board (when verified)
...
| Claude | Heavy writer / hard judgment (contracts, high-stakes messages, scope calls). Not a lawyer. Not daily coder. |
...
- Verbal plan (attorney call): $2500 by end of Sept + October rent by the 10th to reinstate tenancy.
- Written email expected Monday. Need confirmation they hold past Sept 21.
...
|---|---:|---|---|
| Hard Hittin calculator | $600 | UNVERIFIED collect. No reply Sat Sept 19. | Sunday walk-in if open |
| Express Pizza & Scoops (2 locations) | $2000 total | PARTIAL. Numbers talked. Mock contract + demo left. Old contract was 1 site $750+$750. | Close bump: rewrite to $1000+$1000 twin sites. Ordering platform link/embed in scope. Kitchen printer/ticket NOT in $2000. |
| Bascetta DMD (Newington) | $1000 deposit target | NOT STARTED walk-in | Discover first. Site was 404. Demo only after listen. Upside not sole path. |
| Harris in Wonderland | dispute | BLOCKED for housing cash | Counsel / demand track only |
...
- Reasonable revisions in; major changes quoted
